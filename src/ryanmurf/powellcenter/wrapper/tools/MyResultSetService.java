...
*/
public class MyResultSetService implements ResultSetHelper {
  ...
  DecimalFormat dFormatFive;
  DecimalFormat dFormatFour;
  DecimalFormat dFormatThree;
  DecimalFormat dFormatTwo;
  DecimalFormat dFormatOne;
  boolean formatFloatNumber;
  int nDecimals;
  /**
   * Default Constructor.
   */
  public MyResultSetService(boolean formatFloatNumber, int decimals) {
	  dFormatFive = new DecimalFormat("#.#####");
	  dFormatFour = new DecimalFormat("#.####");
	  dFormatThree = new DecimalFormat("#.###");
	  dFormatTwo = new DecimalFormat("#.##");
	  dFormatOne = new DecimalFormat("#.#");
	  this.formatFloatNumber = formatFloatNumber;
  ...
  protected String handleObject(Object obj) {
	...
	protected String getFormattedBig(BigDecimal decimal) {
		if (!formatFloatNumber)
			return decimal.toString();
		switch (nDecimals) {
		case 1:
			return dFormatOne.format(decimal);
		case 2:
			return dFormatTwo.format(decimal);
		case 3:
			return dFormatThree.format(decimal);
		case 4:
			return dFormatFour.format(decimal);
		case 5:
			return dFormatFive.format(decimal);
		default:
			return decimal.toString();
		}
	}
  ...
  protected String handleBigDecimal(BigDecimal decimal) {
     return decimal == null ? "" : getFormattedBig(decimal);//decimal.setScale(4, BigDecimal.ROUND_HALF_EVEN).toString();
  }
